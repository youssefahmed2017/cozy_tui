...
class GlowAnimation:
    ...
    _TEMPLATES: dict[str, list[str]] = {
        ...
        "orange": [
            "#ff8c00", "#ff960a", "#ffa014", "#ffaa1e",
            "#ffb428", "#ffbe32", "#ffc83c", "#ffd246",
            "#ffdc50", "#ffdc50", "#ffd246", "#ffc83c",
            "#ffbe32", "#ffb428", "#ffaa1e", "#ffa014",
            "#ff960a", "#ff8c00",
        ],
        # B=255, G: 80→200→80 (step 15), R=0
        "blue": [
            "#0050ff", "#005fff", "#006eff", "#007dff",
            "#008cff", "#009bff", "#00aaff", "#00b9ff",
            "#00c8ff", "#00c8ff", "#00b9ff", "#00aaff",
            "#009bff", "#008cff", "#007dff", "#006eff",
            "#005fff", "#0050ff",
        ],
        # R=0, G: 160→240→160, B: 40→120→40  (step 10)
        "green": [
            "#00a028", "#00aa32", "#00b43c", "#00be46",
            "#00c850", "#00d25a", "#00dc64", "#00e66e",
            "#00f078", "#00f078", "#00e66e", "#00dc64",
            "#00d25a", "#00c850", "#00be46", "#00b43c",
            "#00aa32", "#00a028",
        ],
        # R=255, G: 0→80→0, B=0  (step 10)
        "red": [
            "#ff0000", "#ff0a00", "#ff1400", "#ff1e00",
            "#ff2800", "#ff3200", "#ff3c00", "#ff4600",
            "#ff5000", "#ff5000", "#ff4600", "#ff3c00",
            "#ff3200", "#ff2800", "#ff1e00", "#ff1400",
            "#ff0a00", "#ff0000",
        ],
        # B=255, R: 140→220→140, G=0  (step 10)
        "purple": [
            "#8c00ff", "#9600ff", "#a000ff", "#aa00ff",
            "#b400ff", "#be00ff", "#c800ff", "#d200ff",
            "#dc00ff", "#dc00ff", "#d200ff", "#c800ff",
            "#be00ff", "#b400ff", "#aa00ff", "#a000ff",
            "#9600ff", "#8c00ff",
        ],
    }
