...
- **[Widgets](https://github.com/youssefahmed2017/cozy_tui/blob/master/docs/widgets.md)** — every widget: `App`, `Box`, `Label`, `Hyperlink`, `Bindings`, `Text`, `Input`, `Button`, `Checkbox`, `MarkdownInput`, `DropFilesArea`, `ListView`, `CheckList`, `RadioSet`, `Dropdown`, `RightClickMenu`, `ProgressBar`, `Spinner`, `Toast`, `Table`, `Tabs`, `Collapsible`, `Tree`, `AnimatedLabel`.
...
- **Widgets**: `Button`, `Checkbox`, `Input`, `Label`, `Hyperlink`, `Bindings`, `AnimatedLabel`, `Text`, `Box`, `MarkdownInput`, `DropFilesArea`, `ListView`, `CheckList`, `RadioSet`, `Dropdown`, `RightClickMenu`, `ProgressBar`, `Spinner`, `Toast`, `Table`, `Tabs`, `Collapsible`, `Tree`
