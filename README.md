...
- **[Widgets](https://github.com/youssefahmed2017/cozy_tui/blob/master/docs/widgets.md)** — every widget: `App`, `Box`, `Label`, `Hyperlink`, `Bindings`, `Rule`, `Code`, `CodeInput`, `Diff`, `Text`, `Markdown`, `MarkdownInput`, `Input`, `Button`, `Checkbox`, `Slider`, `DropFilesArea`, `SearchBar`, `ListView`, `CheckList`, `RadioSet`, `RightClickMenu`, `MenuBar`, `Dropdown`, `ProgressBar`, `Spinner`, `Sparkline`, `BarChart`, `Calendar`, `Image`, `Toast`, `Tooltip`, `Table`, `Tabs`, `ScrollView`, `Log`, `Splitter`, `Collapsible`, `Tree`, `AnimatedLabel`, `TracebackView`.
